...
async def start_conversation(
    ...
    try:
        ...
        return StartConversationResponse(
            session_id=session_id, message=greeting, success=True
        )
...
async def send_message(
    ...
    try:
        ...
        history_updated = session_service.add_message_to_history(
            session_id, request.message, bot_response
        )
        logger.info(f"History updated: {history_updated}")

        return MessageResponse(
            session_id=session_id, message=bot_response, success=True
        )
...
async def debug_sessions(
    ...
    try:
        ...
        return SessionDebugResponse(
            total_sessions=len(sessions), session_ids=list(sessions.keys())
        )
